...
public class MediaTypes {
    ...
    public static final MediaType APPLICATION_JSON_UTF_8_MediaType = newMediaType(APPLICATION_JSON_UTF_8);

    /**
     * 创建MediaType
     * 用new MediaType(APPLICATION_JSON_UTF_8_VALUE);将报错
     */
    public static MediaType newMediaType(String type) {
     ...
     */
    public static MediaType newMediaType(String type, String subType, Charset charset) {
